...
window.addEventListener('DOMContentLoaded', async function(event) {
  ...
  // ⬇️ ⬇️ ⬇️
  let response = await fetch('https://api.themoviedb.org/3/movie/now_playing?api_key=735e39fc5e75cf327e233666d31a2e63&language=en-US')  
  ...
  let watched = querySnapshot.data()
  console.log (watched)
   if (watched){
    document.querySelector('.movies').insertAdjacentHTML('beforeend', `
    <div class="movies-${movieId} opacity-20 w-1/5 p-4">
